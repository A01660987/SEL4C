from SEL4C.models import Gender, Country, User, Administrator, Group, Institution, AcademicDegree, AcademicDegreeOffer, AcademicDiscipline, DiagnosisQuestion, Test, TrainingReagent
...
administrator = User.objects.create(email="admin@tec.mx", name="José Carlos", firstLastname="Vázquez", age=47, password="1230", gender = genders[0], country = countries[0])
...
academicDegreeOffers = AcademicDegreeOffer.objects.bulk_create([
    AcademicDegreeOffer(institution=institutions[0], academicDegree=academicDegrees[0], denomination="Pregrado"), 
    AcademicDegreeOffer(institution=institutions[0], academicDegree=academicDegrees[0], denomination="Posgrado"), 
    AcademicDegreeOffer(institution=institutions[0], academicDegree=academicDegrees[0], denomination="Educación continua"), 
])

academicDisciplines = AcademicDiscipline.objects.bulk_create([
    AcademicDiscipline(denomination="Ingeniería y Ciencias", academicDegreeOffer=academicDegreeOffers[0]), 
    AcademicDiscipline(denomination="Humanidades y Educación", academicDegreeOffer=academicDegreeOffers[0]), 
    AcademicDiscipline(denomination="Ciencias Sociales", academicDegreeOffer=academicDegreeOffers[0]), 
    AcademicDiscipline(denomination="Ciencias de la Salud", academicDegreeOffer=academicDegreeOffers[0]), 
    AcademicDiscipline(denomination="Arquitectura, Arte y Diseño", academicDegreeOffer=academicDegreeOffers[0]), 
    AcademicDiscipline(denomination="Negocios", academicDegreeOffer=academicDegreeOffers[0]), 
    AcademicDiscipline(denomination="Ingeniería y Ciencias", academicDegreeOffer=academicDegreeOffers[1]), 
    AcademicDiscipline(denomination="Humanidades y Educación", academicDegreeOffer=academicDegreeOffers[1]), 
    AcademicDiscipline(denomination="Ciencias Sociales", academicDegreeOffer=academicDegreeOffers[1]), 
    AcademicDiscipline(denomination="Ciencias de la Salud", academicDegreeOffer=academicDegreeOffers[1]), 
    AcademicDiscipline(denomination="Arquitectura, Arte y Diseño", academicDegreeOffer=academicDegreeOffers[1]), 
    AcademicDiscipline(denomination="Negocios", academicDegreeOffer=academicDegreeOffers[1]), 
    AcademicDiscipline(denomination="Ingeniería y Ciencias", academicDegreeOffer=academicDegreeOffers[2]), 
    AcademicDiscipline(denomination="Humanidades y Educación", academicDegreeOffer=academicDegreeOffers[2]), 
    AcademicDiscipline(denomination="Ciencias Sociales", academicDegreeOffer=academicDegreeOffers[2]), 
    AcademicDiscipline(denomination="Ciencias de la Salud", academicDegreeOffer=academicDegreeOffers[2]), 
    AcademicDiscipline(denomination="Arquitectura, Arte y Diseño", academicDegreeOffer=academicDegreeOffers[2]), 
    AcademicDiscipline(denomination="Negocios", academicDegreeOffer=academicDegreeOffers[2]), 
])
...
diagnosisQuestions = DiagnosisQuestion.objects.bulk_create([
    ...
    DiagnosisQuestion(question="Cuando algo me apasiona hago lo posible para lograr mis metas."), 
    DiagnosisQuestion(question="Cuando mi trabajo me apasiona hago lo posible por concluirlo, aunque enfrente circunstancias adversas, falta de tiempo o distractores."), 
    DiagnosisQuestion(question="A pesar del rechazo o problemas, siempre busco conseguir mis objetivos."), 
    DiagnosisQuestion(question="Soy tolerante ante situaciones ambiguas o que me generen incertidumbre."), 
    DiagnosisQuestion(question="Tengo la capacidad de establecer una meta clara y los pasos para lograrla."), 
    DiagnosisQuestion(question="Es común que logre convencer a otros sobre mis ideas y acciones."), 
    DiagnosisQuestion(question="Domino diferentes formas de comunicar mis ideas: por escrito, en un video o en charlas cara a cara."), 
    DiagnosisQuestion(question="Se me facilita delegar actividades a los miembros de mi equipo de acuerdo con sus perfiles."), 
    DiagnosisQuestion(question="Tengo la habilidad de identificar las fortalezas y debilidades de las personas con las que trabajo."), 
    DiagnosisQuestion(question="Se me facilita colaborar de manera activa en un equipo para lograr objetivos comunes."), 
    DiagnosisQuestion(question="Me apasiona trabajar en favor de causas sociales."), 
    DiagnosisQuestion(question="Creo que la misión de mi vida es trabajar para el cambio social y mejorar la vida de las personas."), 
    DiagnosisQuestion(question="Me interesa dirigir una iniciativa con resultados favorables para la sociedad y/o el medio ambiente."), 
    DiagnosisQuestion(question="Soy capaz de identificar problemas en el entorno social o ambiental para generar soluciones innovadoras."), 
    DiagnosisQuestion(question="Manifiesto un compromiso por participar en aspectos sociales de mi entorno."), 
    DiagnosisQuestion(question="Opino que el crecimiento económico debe ocurrir en igualdad de oportunidades y equidad para todos."), 
    DiagnosisQuestion(question="Mis acciones y comportamientos se rigen por normas morales basadas en el respeto y cuidado hacia las personas y a la naturaleza."), 
    DiagnosisQuestion(question="Sé cómo aplicar estrategias para crear nuevas ideas o proyectos."), 
    DiagnosisQuestion(question="Sé aplicar conocimientos contables y financieros para el desarrollo de un emprendimiento."), 
    DiagnosisQuestion(question="Tengo nociones sobre la logística para llevar a cabo la gestión de una organización."), 
    DiagnosisQuestion(question="Sé cómo realizar un presupuesto para lograr un proyecto."), 
    DiagnosisQuestion(question="Sé cómo establecer criterios de valoración y medir los resultados de impacto social."), 
    DiagnosisQuestion(question="Creo que el cometer errores nos ofrece nuevas oportunidades de aprendizaje."), 
    DiagnosisQuestion(question="Conozco estrategias para desarrollar un proyecto, aún con escasez de recursos."), 
    #Pensamiento Complejo
    DiagnosisQuestion(question="Tengo la capacidad de encontrar asociaciones entre las variables, condiciones y restricciones en un proyecto."), 
    DiagnosisQuestion(question="Identifico datos de mi disciplina y de otras áreas que contribuyen a resolver problemas."), 
    DiagnosisQuestion(question="Participo en proyectos que se tienen que resolver utilizando perspectivas Inter/multidisciplinarias."), 
    DiagnosisQuestion(question="Organizo información para resolver problemas."), 
    DiagnosisQuestion(question="Me agrada conocer perspectivas diferentes de un problema."), 
    DiagnosisQuestion(question="Me inclino por estrategias para comprender las partes y el todo de un problema."), 
    DiagnosisQuestion(question="Tengo la capacidad de Identificar los componentes esenciales de un problema para formular una pregunta de investigación."), 
    DiagnosisQuestion(question="Conozco la estructura y los formatos para elaborar reportes de investigación que se utilizan en mi área o disciplina."), 
    DiagnosisQuestion(question="Identifico la estructura de un artículo de investigación que se maneja en mi área o disciplina."), 
    DiagnosisQuestion(question="Identifico los elementos para formular una pregunta de investigación."), 
    DiagnosisQuestion(question="Diseño instrumentos de investigación coherentes con el método de investigación utilizado."), 
    DiagnosisQuestion(question="Formulo y pruebo hipótesis de investigación."), 
    DiagnosisQuestion(question="Me inclino a usar datos científicos para analizar problemas de investigación."), 
    DiagnosisQuestion(question="Tengo la capacidad para analizar críticamente problemas desde diferentes perspectivas."), 
    DiagnosisQuestion(question="Identifico la fundamentación de juicios propios y ajenos para reconocer argumentos falsos."), 
    DiagnosisQuestion(question="Autoevalúo  el nivel de avance y logro de mis metas para hacer los ajustes necesarios."), 
    DiagnosisQuestion(question="Utilizo razonamientos basados en el conocimiento científico para emitir juicios ante un problema."), 
    DiagnosisQuestion(question="Me aseguro de revisar los lineamientos éticos de los proyectos en los que participo."), 
    DiagnosisQuestion(question="Aprecio críticas en el desarrollo de proyectos para mejorarlos."), 
    DiagnosisQuestion(question="Conozco los criterios para determinar un problema."), 
    DiagnosisQuestion(question="Tengo la capacidad de identificar las variables, de diversas disciplinas, que pueden ayudar a responder preguntas."), 
    DiagnosisQuestion(question="Aplico soluciones innovadoras a diversas problemáticas."), 
    DiagnosisQuestion(question="Soluciono problemas interpretando datos de diferentes disciplinas."), 
    DiagnosisQuestion(question="Analizo problemas de investigación contemplando el contexto para crear soluciones."), 
    DiagnosisQuestion(question="Tiendo a evaluar con sentido crítico e innovador las soluciones derivadas de un problema."), 
])
...
trainingReagents = TrainingReagent.objects.bulk_create([
    TrainingReagent(denomination="Identificación", 
                    goals=None, 
                    description=None, 
    ...
    TrainingReagent(denomination="Investigación", 
                    goals=None, 
    ...
    TrainingReagent(denomination="Ideación", 
                    goals=None, 
