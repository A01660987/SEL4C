# Generated by Django 4.2.5 on 2023-10-17 00:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('activity', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='SEL4C.activity', verbose_name='Activity')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(choices=[('U', 'Upload'), ('T', 'Text'), ('R', 'Rating')], max_length=1, verbose_name='Tipo')),
                ('submitted', models.DateTimeField(auto_now=True, verbose_name='Fecha de submit')),
                ('exercise', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='SEL4C.exercisestep', verbose_name='Exercise')),
                ('rating_answer', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='SEL4C.answerrating', verbose_name='Rating')),
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='SEL4C.student', verbose_name='Student')),
                ('text_answer', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='SEL4C.answertext', verbose_name='Text')),
                ('upload_answer', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='SEL4C.answerupload', verbose_name='Upload')),
            ],
            options={
                'verbose_name': 'Answer',
        ...
        migrations.AddField(
            model_name='activity',
            name='activity_text',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='SEL4C.activitytext', verbose_name='Activity text'),
        ),
    ]
